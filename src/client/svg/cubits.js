...
export class CubitRecover extends React.Component {
  static propTypes = {
    team: PropTypes.string,
    name: PropTypes.string,
  };
...
export class CubitBleed extends React.Component {
  static propTypes = {
    team: PropTypes.string,
    name: PropTypes.string,
  };
...
export class CubitDestroy extends React.Component {
  static propTypes = {
    team: PropTypes.string,
    name: PropTypes.string,
  };
...
export class CubitEliminate extends React.Component {
  static propTypes = {
    team: PropTypes.string,
    name: PropTypes.string,
  };
...
export function getCubitElement(cubit, isPlayer = false) {
  ...
  if(data.hidden === true && isPlayer === false) {
    ...
    return React.createElement(CubitBleed, params);
    ...
    return React.createElement(CubitRecover, params);
  } else if(cubit.type === CUBITS.Destroy) {
    return React.createElement(CubitDestroy, params);
  } else if(cubit.type === CUBITS.Eliminate) {
