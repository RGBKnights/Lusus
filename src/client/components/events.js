...
export class EventLog extends React.Component {
  ...
  render() {
    ...
    return [
      <Button key="btn-events" className="btn-block" color="primary" title="Event Log" onClick={this.toggle}>Events</Button>,
      <Modal  key="modal-events" size="lg" isOpen={this.state.modal} toggle={this.toggle}>
